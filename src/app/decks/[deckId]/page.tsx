...
export default function DeckPage() {
  ...
  // cards: 이 단어장에 속한 카드 목록입니다. 처음에는 빈 배열이었다가,
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 p-8">
      ...
      {/* 새로 만든 단어장처럼 카드가 하나도 없으면, 카드 대신 안내 문구만 보여줍니다.
          currentCard가 undefined인 채로 Flashcard에 넘기면 그 안에서 card.particle을
          읽다가 에러가 나기 때문에 이렇게 갈라둡니다. */}
      {cards.length === 0 ? (
